  ...
  return (
    <ul className={css['socials-menu']}>
      <li className={css['socials-item']}>
        <a className={css['socials-link']} href="https://github.com/Serhiy-Slipchuk/goit-react-hw-08-phonebook" target='_blank' rel="noreferrer noopener nofollow">
          <BsGithub className={css['socials-icon']} />
        </a>
      </li>
      <li className={css['socials-item']}>
        <a className={css['socials-link']} href="https://www.linkedin.com/in/serhiy-slipchuk-a83858266/" target='_blank' rel="noreferrer noopener nofollow">
